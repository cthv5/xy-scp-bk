...
.content
  ...
  el-form.padding(inline, :model="formItem.model", ref="searchForm", :label-width="'70px'")
    el-form-item(:label="item.lbl", v-for="item in formItem.form", :key="item.prop", clearable)
